...
_path = r"D:\VS\VC\VC\Tools\MSVC\14.29.30133\bin\Hostx64\x64"
...
def PixelIndexCal_cuda(geo):
    ...
    sino_indices = torch.zeros(geo['nVoxelX']*geo['nVoxelY']*geo['extent'], geo['views']).type(torch.FloatTensor)
